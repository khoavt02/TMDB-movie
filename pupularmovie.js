const popularApi = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=07df55c2a008a76039b5e2e7c8900ed4";
function showPopularMovie(movies){
    ...
    movies.forEach((movie) => {
        ...
        `;
        popular_main.appendChild(movieEl);
